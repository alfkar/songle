...
function Command({
  ...
  return (
    <div className={cn("relative !p-0", className)}>
      ...
      <div
        className="absolute top-1.5 -left-1.5 h-1/2 w-1.5 bg-foreground dark:bg-ring" />
      <div
        className="absolute top-1.5 -right-1.5 h-1/2 w-1.5 bg-foreground dark:bg-ring" />
      <div
        className="absolute bottom-1.5 -left-1.5 h-1/2 w-1.5 bg-foreground dark:bg-ring" />
      <div
        className="absolute bottom-1.5 -right-1.5 h-1/2 w-1.5 bg-foreground dark:bg-ring" />
    </div>
  );
}
  ...
  return (
    <div
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "placeholder:text-muted-foreground flex-1 min-w-0 h-10 rounded-md bg-transparent py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50 truncate",
          className
        )}
        {...props} />
    </div>
